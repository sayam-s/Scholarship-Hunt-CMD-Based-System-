...
//--------------------------------------------------------------------------------Menus-----------------------------------------------------------------------------------
			...
			while(condition){
				...
				System.out.println("""
			           ...
			           | (___   ___| |__   ___ | | __ _ _ __ ___| |__  _ _ __  
			            ...
			            ____) | (__| | | | (_) | | (_| | |  \\__ \\ | | | | |_) |
			      _    |_____/ \\___|_| |_|\\___/|_|\\__,_|_|  |___/_| |_|_| .__/ 
			     | |  | |           | |                                 | |    
			     | |__| |_   _ _ __ | |_                                |_|    
			     |  __  | | | | '_ \\| __|                                      
			     | |  | | |_| | | | | |_                                       
				...
				System.out.println("\t\tWELCOME TO SCHOLARSHIP HUNT!");
		...
		public static void AdminMenu() throws Exception, FileNotFoundException, IOException{
			...
			while(condition){
				...
				System.out.println("\t\tWELCOME TO \u001B[1mADMIN PANEL!");
				...
				while(!(str.equals("1") || str.equals("2") || str.equals("3") || str.equals("4") || str.equals("5") || str.equals("6") || str.equals("7"))){
						System.out.print("\tInvalid Entry! Choose Again:  ");
						str = in.next();
				}//while
		...
		public static void ApplicantVerification() throws Exception{
			...
			if(ch == '1'){
				...
				if(file.exists()){
					...
					System.out.println("\n\tWrong CNIC! You Have not been Registered OR You have entered incorrect information!");
...
//---------------------------------------------------------------------Student Registration Methods-----------------------------------------------------------------------
			...
			while(cnic == null || cnic.equals("") || !cnic.matches("^\\d{5}-\\d{7}-\\d{1}$") || file.exists()){
				...
				if(cnic == null || cnic.equals("") || !cnic.matches("^\\d{5}-\\d{7}-\\d{1}$")){
					System.out.print("\t\tWrong Format! Enter CNIC Again (XXXXX-XXXXXXX-X): ");
					cnic = in.next();
				}//if
				else if(file.exists()){
					System.out.print("\t\tCNIC Already Registered! Enter CNIC Again (XXXXX-XXXXXXX-X): ");
					cnic = in.next();
				}//else-if
			...
			while(gender != '1' && gender != '2' && gender != '3'){
				System.out.print("\t\tChoose Gender Again: ");
				gender = in.next().charAt(0);
			}//while
			switch(gender){
				case '1': 
			...
			while(dob == null || dob.equals("") || !dob.matches("^\\d{4}-\\d{2}-\\d{2}$")){
				System.out.print("\t\tEnter Date of Birth Again (YYYY-MM-DD): ");
				dob = in.next();
			}//while
			...
			while(!WordChecker(religion)){
				System.out.print("\t\tEnter Religion Again: ");
				religion = in.next();
			}//while
			...
			while(!WordChecker(nationality)){
				System.out.print("\t\tEnter Nationality Again: ");
				nationality = in.next();
			}//while
			...
			while(maritalStatus != '1' && maritalStatus != '2'){
				System.out.print("\t\tChoose Marital Status Again: ");
				maritalStatus = in.next().charAt(0);
			}//while
			...
			ch = in.next().charAt(0);
			while(ch != '1' && ch != '2' && ch != '3'){
				System.out.print("\t\tChoose Degree Again: ");
				ch = in.next().charAt(0);
			}//while
			switch(ch){
				case '1': 
			...
			while(!StringChecker(major)){
				System.out.print("\t\tEnter Major Again: ");
				major = input.nextLine();
			}//while
			...
			while(!StringChecker(dept)){
				System.out.print("\t\tEnter Department Again: ");
				dept = input.nextLine();
			}//while
			...
			while(semester < 1 || semester > 8){
				System.out.print("\t\tEnter Semester Again: ");
				semester = sc.nextInt();
			}//while
			...
			while(!StringChecker(institute)){
				System.out.print("\t\tEnter Institute Again: ");
				institute = input.nextLine();
			}//while
		...
		public static Guardian StoreGuardianData(){
			...
			while(cnic == null || cnic.equals("") || !cnic.matches("^\\d{5}-\\d{7}-\\d{1}$")){
				...
				/*In the condition above, ^ means start of string, \\d means the digit, {n} means the number of digits,
				 - reprsents the dashes in between, $ means end of string.*/
				System.out.print("\t\tEnter CNIC Again (XXXXX-XXXXXXX-X): ");
				cnic = in.next();
			}//while
			...
			while(!WordChecker(relation)){
				System.out.print("\t\tEnter Relation Again: ");
				relation = in.next();
			}//while
			...
			while(!StringChecker(occupation)){
				System.out.print("\t\tEnter Occupation Again: ");
				occupation = input.nextLine();
			}//while
			...
			while(monthlyIncome < 0){
				System.out.print("\t\tEnter Monthly Income Again: ");
				monthlyIncome = sc.nextDouble();
			}//while			
			...
			while(annualIncome < 0){
				System.out.print("\t\tEnter Annual Income Again: ");
				annualIncome = sc.nextDouble();
			}//while
		...
		public static Address StoreAddressData(){
			...
			while(!StringChecker(province)){
				System.out.print("\t\tEnter Province Again: ");
				province = input.nextLine();
			}//while
			...
			while(!StringChecker(district)){
				System.out.print("\t\tEnter District Again: ");
				district = input.nextLine();
			}//while
			...
			houseNo = sc.nextInt();
			while(houseNo < 0){
				System.out.print("\t\tEnter House No. Again: ");
				houseNo = sc.nextInt();
			}//while
			...
			while(!postalCode.matches("^\\d+$")){
				System.out.print("\t\tEnter Postal Code Again: ");
				postalCode = in.next();
			}//while
		...
		public static AcademicRecord StoreAcademicData(){
			...
			while(!StringChecker(middle)){
				System.out.print("\t\tEnter Middle School Name Again: ");
				middle = input.nextLine();
			}//while
			...
			while(!StringChecker(high)){
				System.out.print("\t\tEnter High School Name Again: ");
				high = input.nextLine();
			}//while
			...
			while(!StringChecker(college)){
				System.out.print("\t\tEnter College Name Again: ");
				college = input.nextLine();
			}//while
			...
			while(!StringChecker(uni)){
				System.out.print("\t\tEnter University Name Again: ");
				uni = input.nextLine();
			}//while
			...
			while(middleEnd < 0){
				System.out.print("\t\tEnter Middle School End Year Again: ");
				middleEnd = sc.nextInt();
			}//while
			...
			highEnd = sc.nextInt();
			while(highEnd < 0){
				System.out.print("\t\tEnter High School End Year Again: ");
				highEnd = sc.nextInt();
			}//while
			...
			while(collegeEnd < 0){
				System.out.print("\t\tEnter College End Year Again: ");
				collegeEnd = sc.nextInt();
			}//while
			...
			uniEnd = sc.nextInt();
			while(uniEnd < 0){
				System.out.print("\t\tEnter University End Year Again: ");
				uniEnd = sc.nextInt();
			}//while
			...
			while(totalHigh < 0){
				System.out.print("\t\tEnter Total Marks Again: ");
				totalHigh = sc.nextDouble();
			}//while
			...
			while(obtHigh < 0 || obtHigh > totalHigh){
				System.out.print("\t\tEnter Obtained Marks Again: ");
				obtHigh = sc.nextDouble();
			}//while
			...
			while(noOfDegrees < 0){
				System.out.print("\t\tEnter No. Of Degrees Again: ");
				noOfDegrees = sc.nextInt();
			}//while
...
//------------------------------------------------------------------Student Unregistration Method--------------------------------------------------------------------
		...
		public static void UnregisterStudent(){
			...
			System.out.println("\n\n\n\t┌--------------------------------------┐");
			System.out.println("\t|\t STUDENT UNREGISTERATION       |");
			System.out.println("\t└--------------------------------------┘\n\n");
		...
		public static void ViewRegisteredStudents() throws FileNotFoundException{
			...
			if(folder.exists() && folder.isDirectory()){
				...
				if(files != null){
					...
					System.out.println("\t\t\t\t└-----------------------------------------------------------------┘\n\n");
					System.out.printf("\n\t\t " + "%-11s %-16s %-26s %-21s %-21s\n", "First Name", "Last Name", "Email", "CNIC", "Phone");							System.out.print("");
					System.out.print("\n\t\t");
					for(int i = 1; i <= 95; i++){
						System.out.print("-");
					}//for
		...
		public static void ReadUnregisteredStudents() throws Exception{
			...
			if(folder.exists() && folder.isDirectory()){
				...
				if(files != null){
					...
					System.out.println("\n\t\t\u001B[30mNo Students Unregistered Yet!");
				}//else
		...
		public static void ReadRegisteredScholarships()throws Exception{
			...
			if(folder.exists() && folder.isDirectory()){
				...
				if(files != null){
					...
					System.out.println("\n\t\t\u001B[30mNo Scholarships Registered Yet!");
				}//else
		...
		public static void ReadArchivedScholarships()throws Exception{
			...
			if(folder.exists() && folder.isDirectory()){
				...
				if(files != null){
					...
					System.out.println("\n\t\t\u001B[30mNo Scholarships Archived Yet!");
				}//else
...
//-----------------------------------------------------------------Scholarship Registration-------------------------------------------------------------------
		...
		public static Scholarship RegisterDisabilityBased(){
			...
			System.out.println("\n\t┌-----------------------------------------┐");
			System.out.println("\t|\tDISABILITY-BASED SCHOLARSHIP   \t  |");
			System.out.println("\t└-----------------------------------------┘\n\n");
			System.out.println("\n\tFILL IN THE FOLLOWING FIELDS.");
			...
			name = input.nextLine();
			while(!StringChecker(name)){
				System.out.print("\t\tEnter Scholarship Name Again: ");
				name = input.nextLine();
			}//while
			...
			while(!StringChecker(disabilityType)){
				System.out.print("\t\tEnter Disability Type Again: ");
				disabilityType = input.nextLine();
			}//while
			...
			while(minGPA < 0.0 || minGPA == 0.0){
				System.out.print("\t\tEnter Minimum GPA Again: ");
				minGPA = sc.nextDouble();
			}//while
		...
		public static Scholarship RegisterSportBased(){
			...
			System.out.println("\n\t┌-----------------------------------------┐");
			System.out.println("\t|\t   SPORTS-BASED SCHOLARSHIP   \t  |");
			System.out.println("\t└-----------------------------------------┘\n\n");
			System.out.println("\n\tFILL IN THE FOLLOWING FIELDS.");
			...
			while(!StringChecker(sportType)){
				System.out.print("\t\tEnter Sport Type Again: ");
				sportType = input.nextLine();
			}//while
			...
			while(!StringChecker(eligibilityLevel)){
				System.out.print("\t\tEnter Eligibility Level Again: ");
				eligibilityLevel = input.nextLine();
			}//while
		...
		public static Scholarship RegisterMeritBased(){
			...
			System.out.println("\n\t┌-----------------------------------------┐");
			System.out.println("\t|\t   MERIT-BASED SCHOLARSHIP   \t  |");
			System.out.println("\t└-----------------------------------------┘\n\n");
			System.out.println("\n\tFILL IN THE FOLLOWING FIELDS.");
		...
		public static Scholarship RegisterNeedBased(){
			...
			System.out.println("\n\t┌-----------------------------------------┐");
			System.out.println("\t|\t    NEED-BASED SCHOLARSHIP   \t  |");
			System.out.println("\t└-----------------------------------------┘\n\n");
			System.out.println("\n\tFILL IN THE FOLLOWING FIELDS.");
			...
			while(familyIncomeLimit < 0.0 || familyIncomeLimit == 0.0){
				System.out.print("\t\tEnter Family Income Limit Again: ");
				familyIncomeLimit = sc.nextDouble();
			}//while
		...
		public static void ArchiveScholarship() throws Exception{
			...
			if(file.isFile() && file.getName().endsWith(".txt")){
				...
				if(deadline.isBefore(today)){
					...
					if(moved){
					System.out.println("\u001B[30mArchived: " + file.getName() + "");
					} 
					else{
					System.out.println("\u001B[30mCould not archive: " + file.getName() + "");
					}
				}
				}
			}
...
//-------------------------------------------------------------------View All Applicants-------------------------------------------------------------------
		...
		public static void ViewAllApplicants() throws IOException{
			...
			System.out.println("\n\n\t\t\u001B[34mAll applicants shown");
			System.out.print("\n\t\tDo you want to see detailed info of a student? (\u001B[32m yes / no ): ");
...
//----------------------------------------------------------------------Apply Student---------------------------------------------------------------------
		...
		public static void ApplyStudent() throws Exception{
			...
			File file = new File(folder, _file);
			if(file.exists()){
				System.out.println("\u001B[30mFile found.");
				found = true ;
			} //if
			else{
				System.out.println("\n\t\tFile not found.");
			...
			if(!found) {
				System.out.println("\n\t\tCNIC is incorrect or is not registered!.");
				return;
			}//if
			else if(found){
				...
				while(applying){
					...
					ViewAllScholarships() ;
					System.out.println("\n\t\t\u001B[34mEnter the name of Scholarship which you want to apply for : ") ;
					...
					System.out.println("\n\t\t\u001B[34mYou have successfully applied for a Scholarship");
